					...
					{menu.map((menu) => (
						...
						>
							{menu.name !== "Resume" ? (
								...
								<a
									className="text-amber-300 border border-amber-300 rounded-xl bg-transparent hover:bg-gradient-to-r hover:from-amber-400 hover:to-orange-500 hover:text-white hover:border-[#161616] px-6 py-3 "
									href={resume}
									target="_blank"
									rel="noreferrer"
								>
