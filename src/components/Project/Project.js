	...
	return (
		...
		>
			<a className="md:flex md:flex-start" href={link} target="_blank" rel="noreferrer">
				<img
					className="relative max-w-4xl w-full h-[400px] md:h-[500px] object-cover grayscale hover:grayscale-0 cursor-pointer"
			...
			<article className="text-neutral-300 flex flex-col justify-center items-center absolute bg-neutral-900/95 w-full h-full p-5 md:flex">
				...
				<p className="text-neutral-400 max-w-lg my-3">{description}</p>
				...
				<div className="flex max-w-lg my-3">
					{link ? (
						<a
							...
							rel="noreferrer"
						>
							<BiLinkExternal className="w-9 h-9 hover:text-rose-400 m-3"/>
						</a>
					) : (
						""
					)}
